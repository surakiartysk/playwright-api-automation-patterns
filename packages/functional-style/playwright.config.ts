...
/**
 * Note `webServer`: Playwright boots the bundled mock before the run and tears
 * it down after. That is what makes `pnpm install && pnpm test` work on a
 * fresh clone with no backend, no credentials, and no setup steps.
 */
